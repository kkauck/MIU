document.ready=function(){
	...
	var createInfo = document.getElementById("browseConsoles");
	if(localStorage.length === 0){
	    addGameData();
    	}
		var createHeader = document.createElement("div");
		createHeader.setAttributes("data-role", "collapsible-set");
		createInfo.appendChild(createHeader);
		for (var e = 0, f = localStorage.length; e < f; e++) {
			...
			createHeader.appendChild(newHeader);
